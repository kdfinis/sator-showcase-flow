...
export const TAGLINE = "Redizajn procesa i digitalizacija poslovanja.";
...
export const SERVICE_AREA = "Hrvatska i regija, rad na daljinu i na terenu";
...
export const NAV_LINKS = [
  { to: "/", label: "Početna" },
  { to: "/paketi", label: "Usluge" },
  { to: "/faq", label: "Pitanja" },
