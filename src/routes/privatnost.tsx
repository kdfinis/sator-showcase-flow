...
import { LEGAL_NAME, OIB, ADDRESS, EMAIL, isPlaceholder, mailHref } from "@/lib/site";
...
function P({ v }: { v: string }) {
  return isPlaceholder(v) ? <span className="text-[color:var(--muted-text)]">{v}</span> : <>{v}</>;
}
        ...
        <div className="container-wide max-w-3xl">
          ...
          <Reveal>
            <h1 className="mt-14 text-4xl md:text-6xl tracking-[-0.04em] font-medium leading-[1.02]">
              Politika <span className="text-[color:var(--brand)] font-medium">privatnosti</span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <p className="mt-10 text-[16px] leading-relaxed text-[color:var(--ink)]/85">
              Ova stranica objašnjava kako Sator Digital obrađuje podatke koje pošaljete kroz
              kontakt formu, email, telefon ili WhatsApp.
            </p>
          </Reveal>
          ...
          <div className="mt-14">
            <Section title="Voditelj obrade" num="01">
              <ul className="space-y-1">
                <li>
                  Voditelj obrade: <P v={LEGAL_NAME} />
                </li>
                <li>
                  OIB: <P v={OIB} />
                </li>
                ...
                <li>
                  ...
                  {isPlaceholder(EMAIL) ? (
                    ...
                    <a
                      href={mailHref()}
                      className="underline underline-offset-4 decoration-[color:var(--brand)]"
                    >
                      {EMAIL}
                    </a>
                  )}
            ...
            <Section title="Koje podatke prikupljamo" num="02">
              Prikupljamo podatke koje sami pošaljete, uključujući ime i prezime, naziv
              organizacije, ulogu, kontakt podatke i sadržaj poruke.
            </Section>
            <Section title="Svrha obrade" num="03">
              Podatke koristimo kako bismo odgovorili na vaš upit, pripremili ponudu, dogovorili
              uvodni razgovor i pružili uslugu ako se odlučite za suradnju.
            </Section>
            <Section title="Pravna osnova" num="04">
              Obrada se temelji na vašem zahtjevu, komunikaciji prije mogućeg ugovora, izvršenju
              ugovora ako do suradnje dođe i legitimnom interesu za osnovnu poslovnu komunikaciju.
            </Section>
            <Section title="Rok čuvanja" num="05">
              Podatke čuvamo onoliko koliko je potrebno za odgovor na upit, poslovnu komunikaciju,
              ugovorne obveze i zakonske obveze.
            </Section>
            <Section title="Alati trećih strana" num="06">
              Za komunikaciju i tehničko funkcioniranje stranice možemo koristiti alate trećih
              strana kao što su email, hosting, analitika, formulari i komunikacijski alati.
            </Section>
            <Section title="Vaša prava" num="07">
              Možete zatražiti pristup, ispravak, brisanje ili ograničenje obrade svojih podataka u
              skladu s važećim pravilima zaštite osobnih podataka.
            </Section>
